...
#include <lmic/src/lmic/oslmic.h>
#include <lmic/src/hal/hal.h>
...
#define LORA_TASK_STACK_SIZE                   3000
#endif



#define TX_DELAY        100
//#define TX_FREQ         916000000 //node1
//#define TX_FREQ         916600000 //node2
//#define TX_FREQ         918000000 //node3
#define TX_FREQ         918600000 //node4
#define TX_POWER        0  //dBm goes from 2 to 30
#define TX_SF           SF7        //  from 7 to 12
#define TX_BANDWIDTH    BW125       // BW125, BW250, BW500
#define TX_CODINGRATE   CR_4_5      //C_4_5, CR_4_6, CR_4_7, CR_4_8
#define TX_PALOAD_SIZE  40
...
static const u1_t NWKSKEY[16] = { 0x01, 0x11, 0x22, 0x33,
                                          0x44, 0x55, 0x66, 0x77,
                                          0x88, 0x99, 0xaa, 0xbb,
                                          0xcc, 0xdd, 0xee, 0xff };

// LoRaWAN AppSKey, application session key
static const u1_t APPSKEY[16] = { 0x01, 0x11, 0x22, 0x33,
                                          0x44, 0x55, 0x66, 0x77,
                                          0x88, 0x99, 0xaa, 0xbb,
                                          0xcc, 0xdd, 0xee, 0xff };
...
//static uint8_t mydata[] = {0x11, 0x11, 0x11, 0x11,
//                           0x11, 0x11, 0x11, 0x11};
static uint8_t mydata[TX_PALOAD_SIZE] = {0x00};
...
void tx(const char *str, osjobcb_t func) {
  ...
  //os_copyMem(LMIC.frame, LMIC.pendTxData, sizeof(mydata));
